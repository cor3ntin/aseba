...
project = u'Aseba'
copyright = u'2007–2021, Mobsya and other contributors'
authors = u'Mobsya and other contributors'
...
latex_documents = [
    (master_doc, 'Aseba.tex', u'Aseba Documentation', authors, 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'Aseba', u'Aseba Documentation',
     authors, 'Aseba', 'A set of tools which allow beginners to program robots easily and efficiently.',
     'Miscellaneous'),
]